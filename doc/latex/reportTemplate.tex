...
\begin{figure}[!htb]
\centering
\subfigure[$\beta$=0]{\includegraphics[width=0.49\columnwidth]{images/avgbetaa.jpg}}
\subfigure[$\beta$=0.15]{\includegraphics[width=0.49\columnwidth]{images/avgbetab.jpg}}
\subfigure[$\beta$=0.5]{\includegraphics[width=0.49\columnwidth]{images/avgbetac.jpg}}
\subfigure[$\beta$=1]{\includegraphics[width=0.49\columnwidth]{images/avgbetad.jpg}}
